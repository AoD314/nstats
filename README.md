...
args:
    ...
    -m <int>         show maximum lines of top slow files (default: 314)
...
```
$ ./target/release/nstats -f ../opencv/build/.ninja_log -m 25
Application stats:
       file: ../opencv/build/.ninja_log
    reading:   0.345 ms
    parsing:   1.043 ms
...
Stats:
  cpu time (1T) :    2:09:54.715 (      7794715 ms)
  compile time  :    0:05:33.859 (       333859 ms)
  speed ratio   : 23.35
